...
export const items: Item[] = [
    ...
    {
        id: BigInt(ItemId.BALANCED_MEAL),
    ...
    {
        id: BigInt(ItemId.MUSICAL_INSTRUMENT),
    ...
    {
        id: BigInt(ItemId.EDUCATIONAL_COURSE),
    ...
    {
        id: BigInt(ItemId.PROPERTY_INSURANCE),
    ...
    {
        id: BigInt(ItemId.BANK_WORKER_CLOTHES),
    ...
    {
        id: BigInt(ItemId.FACTORY_WORKER_CLOTHES),
    ...
    {
        id: BigInt(ItemId.HEADHUNTER_WORKER_CLOTHES),
    ...
    {
        id: BigInt(ItemId.INSURANCE_BROKER_CLOTHES),
    ...
    {
        id: BigInt(ItemId.HITECH_WORKER_CLOTHES),
    ...
    {
        id: BigInt(ItemId.CLOTHES_SHOP_WORKER_CLOTHES),
    ...
    {
        id: BigInt(ItemId.FOOD_WORKER_CLOTHES),
    ...
    {
        id: BigInt(ItemId.CHINATOWN_WORKER_CLOTHES),
    ...
    {
        id: BigInt(ItemId.RENT_WORKER_CLOTHES),
    ...
    {
        id: BigInt(ItemId.CHANGE_CLOTHES),
